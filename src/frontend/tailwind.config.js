  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        maroon: { DEFAULT: "#5B1F24", dark: "#4A1920", light: "#7A2D34" },
        gold: { DEFAULT: "#C9A56A", light: "#DFC08A", dark: "#A88248" },
        cream: { DEFAULT: "#F5EAD8", light: "#FBF6EE", dark: "#EFE1C7" },
        brown: { DEFAULT: "#3A2F2C" },
      },
      borderRadius: { lg: "var(--radius)", md: "calc(var(--radius) - 2px)", sm: "calc(var(--radius) - 4px)" },
      boxShadow: { xs: "0 1px 2px 0 rgba(0,0,0,0.05)", heritage: "0 4px 20px rgba(91,31,36,0.12)" },
      keyframes: {
