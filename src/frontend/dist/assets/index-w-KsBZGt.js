    ...
    "nav",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-serif text-lg font-bold tracking-wider text-gold", children: "IKAT" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-serif text-lg font-bold tracking-wider text-cream-light", children: "DIRECT" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "select",
          {
            ...
            children: PAGE_TITLES.map((t, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("option", { value: i + 1, children: [
              i + 1,
              ". ",
              t
            ] }, t))
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-sans text-xs text-cream-dark", children: [
            currentPage,
            " / ",
            totalPages
          ] }),
...
function PageHeading({ title }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-serif text-3xl font-bold uppercase tracking-widest text-maroon", children: title }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-3 h-[3px] w-full rounded-full bg-gradient-to-r from-gold via-gold-light to-transparent" })
  ] });
}
function FeatureBox({
  icon,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl border border-gold/40 bg-cream-dark p-4 shadow-xs", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-1 text-2xl", children: icon }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-serif text-sm font-bold text-maroon", children: title }),
    desc && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1 font-sans text-xs text-brown/80", children: desc })
  ] });
}
function PageAbstract() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { "data-ocid": "abstract.page", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(PageHeading, { title: "Abstract" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 gap-8 lg:grid-cols-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-2xl border border-gold/30 bg-cream-dark p-6 shadow-heritage", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 font-sans text-sm leading-relaxed text-brown [text-align:justify]", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Traditional handloom industries such as Pochampally weaving represent a rich cultural heritage of India. However, in recent years, these artisans have been facing significant economic and social challenges due to the involvement of middlemen, lack of direct market access, and limited digital exposure. As a result, weavers often receive low profits despite the high value of their products." }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
          "This mini project proposes a digital service platform called",
          " ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: "text-maroon", children: '"IkatDirect"' }),
          ", which aims to establish a direct connection between weavers and customers. The platform eliminates intermediaries and enables transparent transactions, ensuring fair pricing and better income opportunities for artisans."
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "In addition to e-commerce functionality, the platform integrates advanced features such as live streaming, real-time messaging, and a learning portal. The live streaming feature allows weavers to showcase their products and weaving process interactively, similar to social media platforms." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Overall, this project demonstrates how digital transformation can empower traditional industries, improve livelihoods, and create a sustainable ecosystem that benefits both producers and consumers." })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "overflow-hidden rounded-2xl border-4 border-gold/60 shadow-heritage", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "img",
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "bg-maroon px-4 py-2 text-center font-sans text-xs text-gold", children: "Authentic Pochampally Ikat Saree" })
      ] }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-8 rounded-xl border-2 border-gold bg-cream-dark p-5 shadow-heritage", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "shrink-0 rounded-lg bg-maroon px-3 py-1.5 font-serif text-sm font-bold text-gold", children: "Key Idea" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-sans text-sm leading-relaxed text-brown", children: "Digital platform connecting weavers directly to customers, eliminating middlemen and promoting fair trade." })
    ] }) })
  ] });
}
function PageConclusion() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { "data-ocid": "conclusion.page", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(PageHeading, { title: "Conclusion" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-8 space-y-4 font-sans text-sm leading-relaxed text-brown [text-align:justify]", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "The IkatDirect platform presents a practical and innovative solution to the challenges faced by traditional Pochampally weavers. By leveraging digital technology, the project successfully addresses the issues of middlemen, lack of market access, and limited communication between producers and consumers." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Through the development of a user-friendly digital platform, the project enables direct interaction between weavers and customers, ensuring transparency, fair pricing, and authenticity. The inclusion of advanced features such as live streaming, messaging, and a learning portal further enhances the functionality of the platform." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "The project also highlights the importance of integrating technology with traditional industries to promote sustainability and economic growth. By empowering weavers and providing them with direct market access, the platform contributes to improving their livelihoods and preserving cultural heritage." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "In addition, the structured approach involving timeline planning, critical path method, resource management, and risk analysis demonstrates the feasibility and scalability of the startup." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Overall, IkatDirect serves as a model for how digital platforms can transform traditional sectors, creating opportunities for growth, innovation, and cultural preservation. The project reflects a balance between modern technology and traditional craftsmanship, making it a meaningful and impactful startup initiative." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-8 flex justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-hidden rounded-2xl border-4 border-gold/60 shadow-heritage", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      "img",
      {
        src: "/assets/generated/pochampally-saree.dim_600x400.jpg",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl border-2 border-gold bg-maroon p-6 text-center shadow-heritage", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-serif text-lg font-bold italic text-gold", children: "“Empowering Weavers, Preserving Culture, and Connecting the World.”" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 font-sans text-xs text-cream-light/70", children: "— IkatDirect Mission" })
    ] })
  ] });
}
const tasks = [
...
function PageCriticalPath() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { "data-ocid": "cpm.page", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(PageHeading, { title: "Critical Path Method" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 gap-8 lg:grid-cols-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 font-sans text-sm leading-relaxed text-brown [text-align:justify] lg:col-span-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "The Critical Path Method (CPM) is a project management technique used to identify the sequence of tasks that are essential for the successful completion of a project, helping determine the most important activities that must be completed on time." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "In the development of the IkatDirect platform, CPM plays a crucial role in organizing and managing different stages. Key activities such as platform development, system testing, and final deployment are considered part of the critical path." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "By applying CPM, the project team can effectively monitor progress, allocate resources efficiently, and avoid unnecessary delays. It also helps in identifying non-critical tasks that can be adjusted without affecting the overall schedule." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl border-2 border-gold bg-maroon p-5 shadow-heritage", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "mb-3 font-serif text-sm font-bold text-gold", children: "Definition" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-sans text-xs leading-relaxed text-cream-light", children: "Critical Path is the sequence of tasks that must be completed on time to avoid project delay." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-4 h-px bg-gold/40" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-3 font-sans text-xs italic text-gold/80", children: "Used in: Construction, Software, Project Management" })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-8 rounded-2xl border border-gold/40 bg-cream-dark p-6 shadow-heritage", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "mb-6 text-center font-serif text-base font-bold text-maroon", children: "Critical Path Diagram" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap items-center justify-center gap-0", children: tasks.flatMap((task, i) => [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              ...
              task.critical && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "mt-1 rounded-full bg-gold/20 px-2 py-0.5 font-sans text-xs text-gold", children: "CRITICAL" })
            ]
          },
          task.id
        ),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-6 rounded-xl border border-gold/60 bg-cream-dark p-4 text-center shadow-xs", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-sans text-sm font-semibold text-maroon", children: "⚠ Delay in any critical activity will delay the entire project." }) })
  ] });
}
const products = [
...
function PageCustomerPortal() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { "data-ocid": "customer.page", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(PageHeading, { title: "Customer Portal" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 gap-8 lg:grid-cols-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 font-sans text-sm leading-relaxed text-brown [text-align:justify]", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "The Customer Portal in the IkatDirect platform is designed to provide a seamless and interactive shopping experience for users who wish to purchase authentic Pochampally sarees directly from weavers." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "After logging into the platform as a customer, users are directed to a personalized dashboard where they can browse a wide range of sarees categorized based on design, color, and price." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "One of the key features of the customer portal is the ability to directly interact with weavers. Through integrated messaging and live streaming options, customers can ask questions and observe the weaving process in real time." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Additionally, the portal includes a learning section, where users can enroll in courses or tutorials related to weaving techniques, promoting cultural awareness and skill development." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "The Customer Portal is designed to ensure a smooth, transparent, and enriching experience, bridging the gap between traditional craftsmanship and modern digital consumers." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-serif text-sm font-semibold text-maroon", children: "Product Listings" }),
        products.map((p) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            className: "flex items-center gap-4 rounded-xl border border-gold/40 bg-cream-dark p-4 shadow-xs",
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex h-14 w-14 shrink-0 items-center justify-center rounded-lg bg-maroon/10 text-2xl", children: "🧣" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-sans text-sm font-semibold text-brown", children: p.name }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-sans text-xs text-brown/60", children: "Direct from verified weaver" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-right", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-sans text-sm font-bold text-maroon", children: p.price }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "rounded-full bg-gold/20 px-2 py-0.5 font-sans text-xs text-gold-dark", children: p.tag })
              ] })
            ]
          },
          p.name
        )),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-2 rounded-xl border border-gold/30 bg-maroon/5 p-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mb-2 text-center font-sans text-xs font-bold text-maroon", children: "Customer Flow" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap items-center justify-center gap-1", children: flowSteps.flatMap((s, i) => [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "span",
              {
            ...
            ...i < flowSteps.length - 1 ? [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gold", children: "→" }, `arrow-${s}`)
            ] : []
          ]) })
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-8 grid grid-cols-2 gap-4 sm:grid-cols-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        FeatureBox,
        {
          icon: "🔍",
...
const challenges = [
  {
    ...
    detail: "Many traditional artisans may not be familiar with digital platforms, which can make it difficult for them to use the system effectively."
  },
  {
    icon: "⚙",
    title: "Technical Issues",
    desc: "Website errors, Internet problems",
    detail: "Technical challenges such as website errors, system crashes, or poor internet connectivity in rural areas can affect platform performance."
  },
  {
    icon: "🚚",
    title: "Logistics",
    desc: "Delivery challenges, Product handling",
    detail: "Ensuring timely delivery, maintaining product quality, and handling returns can be complex when dealing with multiple sellers."
  },
  {
    icon: "🏪",
    title: "Competition",
    desc: "Existing platforms, Market pressure",
    detail: "Competing with established e-commerce platforms requires continuous innovation and effective marketing strategies."
  }
];
function PageFailures() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { "data-ocid": "failures.page", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(PageHeading, { title: "Failures and Challenges" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 gap-6 sm:grid-cols-2", children: challenges.map((c) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-3 flex items-center gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "flex h-10 w-10 items-center justify-center rounded-full bg-maroon text-xl shadow-heritage", children: c.icon }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-serif text-base font-bold text-maroon", children: c.title }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-sans text-xs text-brown/70", children: c.desc })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-sans text-sm leading-relaxed text-brown", children: c.detail })
        ]
      },
      c.title
    )) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-6 space-y-3 font-sans text-sm leading-relaxed text-brown [text-align:justify]", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Every startup faces certain challenges during its development and implementation. Identifying these potential failures in advance helps in better planning and improves the chances of success." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Additionally, trust-building between customers and weavers can be a challenge in the initial stages. Customers may hesitate to purchase directly from unknown sellers without proper verification systems." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-6 rounded-xl border-2 border-gold bg-maroon/10 p-5 shadow-xs", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-center font-sans text-sm font-semibold text-maroon", children: "💡 Identifying failures helps in better planning and risk reduction." }) })
  ] });
}
const infoBoxes = [
  {
...
function PageFinance() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { "data-ocid": "finance.page", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(PageHeading, { title: "Finance & Assistance" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 gap-8 lg:grid-cols-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 font-sans text-sm leading-relaxed text-brown [text-align:justify]", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Financial support plays a crucial role in the successful development and sustainability of any startup. For the IkatDirect platform, adequate funding is required for website development, maintenance, marketing, and operational activities." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Initially, funds are required for platform development, including designing, coding, and testing. Additional expenses include server costs, hosting services, and technical tools needed to maintain the platform." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "The startup can also benefit from various financial assistance programs provided by the government including MSME support programs, startup incubation centers, and handloom development initiatives." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Additionally, financial support can be obtained through bank loans, private investors, and crowdfunding platforms, helping in expanding the platform and improving its features over time." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Overall, effective financial management and the utilization of available assistance programs are essential for ensuring the growth and long-term success of the IkatDirect startup." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-4", children: infoBoxes.map((box) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-2 flex items-center gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xl", children: box.icon }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-serif text-sm font-bold text-maroon", children: box.title })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-1", children: box.items.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "li",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "h-1 w-1 shrink-0 rounded-full bg-gold" }),
                  item
                ]
              },
              item
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-8 rounded-xl border-2 border-gold bg-maroon p-4 text-center shadow-heritage", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-sans text-sm font-semibold text-cream-light", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gold", children: "★ " }),
      "Proper funding ensures growth and sustainability of the startup."
    ] }) })
  ] });
}
const features = [
...
function PageFutureScope() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { "data-ocid": "future.page", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(PageHeading, { title: "Future Scope" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-8 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "rounded-full border-2 border-gold bg-maroon px-6 py-2 font-serif text-sm font-bold text-gold shadow-heritage", children: "FUTURE OF IKATDIRECT" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-8 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3", children: features.map((f) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-3 flex h-12 w-12 items-center justify-center rounded-full bg-maroon text-2xl shadow-heritage", children: f.icon }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "mb-2 font-serif text-base font-bold text-maroon", children: f.title }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-sans text-sm leading-relaxed text-brown", children: f.desc })
        ]
      },
      f.title
    )) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 font-sans text-sm leading-relaxed text-brown [text-align:justify]", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "The IkatDirect platform has significant potential for future growth and expansion. As the demand for authentic and handmade products continues to increase, the platform can evolve into a larger digital marketplace supporting artisans from different regions." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "The learning platform can also be expanded by offering certified courses, workshops, and collaborations with institutions, making it a hub for skill development and cultural knowledge sharing." })
    ] })
  ] });
}
function PageIntroduction() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { "data-ocid": "introduction.page", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(PageHeading, { title: "Introduction" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-6 space-y-4 font-sans text-sm leading-relaxed text-brown [text-align:justify]", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Urban environments and traditional industries are both undergoing rapid transformation due to technological advancements and changing market dynamics. While cities are becoming more digitized, many traditional sectors such as handloom weaving still rely on outdated systems of production and distribution." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Pochampally weaving is not only an economic activity but also a representation of cultural identity and craftsmanship. Despite the effort involved, weavers often receive minimal financial returns due to the dominance of middlemen in the supply chain." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-8 grid grid-cols-1 gap-8 lg:grid-cols-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 font-sans text-sm leading-relaxed text-brown [text-align:justify]", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "In today’s digital era, technology provides an opportunity to bridge this gap by creating direct and transparent systems. Digital platforms have transformed industries such as retail, education, and communication by enabling direct access and interaction." }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
          "This project introduces",
          " ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: "text-maroon", children: "IkatDirect" }),
          ", a digital platform designed to connect weavers directly with customers, ensuring better pricing, authenticity, and accessibility."
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "The introduction of such a platform not only supports economic growth but also contributes to the preservation of traditional crafts by combining technology with heritage." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "overflow-hidden rounded-2xl border-4 border-gold/60 shadow-heritage", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "img",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "bg-maroon px-4 py-2 text-center font-sans text-xs text-gold", children: "Traditional Pochampally Weaver at Work" })
      ] }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-2xl border border-gold/40 bg-cream-dark p-6 shadow-heritage", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "mb-6 text-center font-serif text-lg font-bold text-maroon", children: "Problems in Handloom Industry" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap items-center justify-center gap-4", children: [
        ...
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-sans text-xs font-semibold text-cream-light", children: item.label })
          ]
        },
        item.label
      )) })
...
function PagePlatformFeatures() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { "data-ocid": "features.page", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(PageHeading, { title: "Platform Features" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-8 rounded-2xl border border-gold/40 bg-cream-dark p-8 shadow-heritage", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-4 lg:grid-cols-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl border-2 border-gold/60 bg-maroon p-4 shadow-heritage", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-2 text-3xl", children: feats[0].icon }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-serif text-sm font-bold text-gold", children: feats[0].title }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1 font-sans text-xs text-cream-light/80", children: feats[0].desc })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hidden items-center justify-center lg:flex", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex h-32 w-32 items-center justify-center rounded-full border-4 border-gold bg-maroon shadow-heritage", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-serif text-xs font-bold leading-tight text-gold", children: "IKAT DIRECT" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-serif text-xs leading-tight text-cream-light/80", children: "FEATURES" })
      ] }) }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl border-2 border-gold/60 bg-maroon p-4 shadow-heritage", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-2 text-3xl", children: feats[1].icon }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-serif text-sm font-bold text-gold", children: feats[1].title }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1 font-sans text-xs text-cream-light/80", children: feats[1].desc })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl border-2 border-gold/60 bg-maroon p-4 shadow-heritage", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-2 text-3xl", children: feats[2].icon }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-serif text-sm font-bold text-gold", children: feats[2].title }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1 font-sans text-xs text-cream-light/80", children: feats[2].desc })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hidden items-center justify-center lg:flex", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-sans text-xs text-brown/50", children: "Integrated Platform" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl border-2 border-gold/60 bg-maroon p-4 shadow-heritage", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-2 text-3xl", children: feats[3].icon }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-serif text-sm font-bold text-gold", children: feats[3].title }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1 font-sans text-xs text-cream-light/80", children: feats[3].desc })
      ] })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 font-sans text-sm leading-relaxed text-brown [text-align:justify]", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "The IkatDirect platform integrates multiple innovative features that enhance user experience, improve communication, and promote cultural exchange between weavers and customers." }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: "text-maroon", children: "Live Streaming" }),
        " allows weavers to showcase their products and weaving process in real time, enabling customers to view authenticity and make informed purchasing decisions."
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
        "The ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: "text-maroon", children: "Messaging System" }),
        " ",
        "facilitates direct communication, allowing questions, custom designs, and product clarification — improving transparency and trust."
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
        "The ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: "text-maroon", children: "Learning Portal" }),
        " provides users with the opportunity to learn weaving techniques directly from skilled artisans, preserving traditional weaving skills."
      ] })
    ] })
  ] });
}
...
function PageResources() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { "data-ocid": "resources.page", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(PageHeading, { title: "Main Money Material / Resources" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-6 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "rounded-full border-2 border-gold bg-maroon px-6 py-2 font-serif text-sm font-bold text-gold shadow-heritage", children: "RESOURCES REQUIRED FOR IKATDIRECT" }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-8 grid grid-cols-1 gap-6 sm:grid-cols-2", children: boxes.map((box) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        className: `rounded-2xl border-2 p-6 shadow-heritage ${box.cls}`,
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-3 flex items-center gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-3xl", children: box.icon }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: `font-serif text-base font-bold ${box.tc}`, children: box.title })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-2", children: box.items.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "li",
            {
              className: "flex items-center gap-2 font-sans text-sm text-brown",
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "h-1.5 w-1.5 shrink-0 rounded-full bg-gold" }),
                item
              ]
            },
            item
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 font-sans text-sm leading-relaxed text-brown [text-align:justify]", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "The successful development and implementation of the IkatDirect platform requires various resources categorized into human, technical, and material components, all playing a vital role in ensuring smooth functioning." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Effective utilization of these resources is essential for building a strong digital platform. Proper allocation and management of financial resources ensure the long-term sustainability of the startup." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-6 rounded-xl border border-gold/60 bg-cream-dark p-4 text-center shadow-xs", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-sans text-sm font-semibold text-maroon", children: "✅ Efficient resource management ensures project success." }) })
  ] });
}
const pairs = [
...
function PageRiskManagement() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { "data-ocid": "risk.page", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(PageHeading, { title: "Risk Management and Solutions" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-8 rounded-2xl border border-gold/40 bg-cream-dark p-6 shadow-heritage", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-4 flex flex-wrap items-center justify-center gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-xl border-2 border-red-700/60 bg-red-900/20 px-4 py-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-serif text-sm font-bold text-red-800", children: "⚠ Challenges" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-2xl font-bold text-gold", children: "→" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-xl border-2 border-maroon bg-maroon px-4 py-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-serif text-sm font-bold text-gold", children: "✔ Solutions" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-2xl font-bold text-gold", children: "→" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-xl border-2 border-green-700/60 bg-green-900/20 px-4 py-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-serif text-sm font-bold text-green-800", children: "🎯 Success" }) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: pairs.map((pair) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 rounded-lg border border-red-700/30 bg-red-900/10 px-3 py-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-red-700", children: "✗" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-sans text-sm text-brown", children: pair.problem })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 rounded-lg border border-green-700/30 bg-green-900/10 px-3 py-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-green-700", children: "✓" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-sans text-sm text-brown", children: pair.solution })
        ] })
      ] }, pair.problem)) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 font-sans text-sm leading-relaxed text-brown [text-align:justify]", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "In order to ensure the successful implementation of the IkatDirect platform, it is essential to address the identified challenges through effective risk management strategies." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "To overcome the issue of low digital literacy among weavers, training programs and awareness workshops can be conducted. Simple tutorials and multilingual support can help weavers understand and use the platform effectively." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Building trust between customers and weavers is crucial. This can be achieved by verifying weaver profiles, providing product authenticity details, and allowing customer reviews and ratings." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-6 rounded-xl border-2 border-gold bg-maroon p-4 text-center shadow-heritage", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-sans text-sm font-semibold text-cream-light", children: "Proper risk management ensures smooth functioning and long-term sustainability." }) })
  ] });
}
const objectives = [
...
function PageSynopsis() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { "data-ocid": "synopsis.page", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(PageHeading, { title: "Synopsis" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-6 rounded-xl bg-maroon p-6 shadow-heritage", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "mb-3 font-serif text-lg font-bold uppercase tracking-wider text-gold", children: "Aim of the Project" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-sans text-sm leading-relaxed text-cream-light [text-align:justify]", children: [
        "The aim of this project is to develop a digital service platform called ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: "text-gold", children: "IkatDirect" }),
        " that connects Pochampally weavers directly with customers. The platform is designed to eliminate middlemen, ensure fair pricing, and promote transparency in the handloom market. Additionally, it aims to preserve traditional weaving practices by integrating modern technology with cultural heritage."
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-6 rounded-xl border border-gold/40 bg-cream-dark p-6 shadow-xs", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "mb-4 font-serif text-lg font-bold uppercase tracking-wider text-maroon", children: "Objectives" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-2", children: objectives.map((obj) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "li",
        {
          className: "flex items-start gap-3 font-sans text-sm text-brown",
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "mt-0.5 flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-maroon text-xs font-bold text-gold", children: objectives.indexOf(obj) + 1 }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl border border-gold/40 bg-cream-light p-6 shadow-xs", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "mb-6 font-serif text-lg font-bold uppercase tracking-wider text-maroon", children: "Methodology" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap items-center justify-center gap-0", children: steps$1.flatMap((step, i) => [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            className: "flex flex-col items-center rounded-xl border-2 border-gold/60 bg-maroon px-4 py-4 shadow-heritage",
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "mb-1 font-sans text-xs text-gold/70", children: step.n }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-serif text-sm font-bold text-cream-light", children: step.title }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "mt-0.5 font-sans text-xs text-cream-dark/80", children: step.desc })
            ]
          },
          step.n
        ),
...
function PageTimeline1Year() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { "data-ocid": "timeline-1year.page", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(PageHeading, { title: "Project Time Line – 1 Year Plan" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mb-8 font-sans text-sm leading-relaxed text-brown [text-align:justify]", children: "To ensure the successful implementation of the IkatDirect platform, the project follows a structured timeline divided over a period of 6–12 months, allowing for systematic development, testing, and deployment." }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-4", children: phases.map((phase, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        className: "flex flex-col overflow-hidden rounded-xl border border-gold/40 shadow-heritage sm:flex-row",
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex w-full flex-col items-center justify-center bg-maroon p-4 sm:w-40", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-3xl", children: phase.icon }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1 font-serif text-sm font-bold text-gold", children: phase.phase }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-sans text-xs text-cream-light/70", children: phase.period })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-1 items-center gap-6 bg-cream-dark p-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-serif text-base font-bold text-maroon", children: phase.title }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "mt-2 space-y-1", children: phase.points.map((pt) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "li",
                {
                  className: "flex items-center gap-2 font-sans text-sm text-brown",
                  children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "ml-auto hidden flex-col items-end gap-1 sm:flex", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-2 w-32 overflow-hidden rounded-full bg-maroon/10", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-sans text-xs text-brown/50", children: [
                (i + 1) * 25,
                "% Complete"
              ] })
            ] })
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-6 rounded-xl border-2 border-gold bg-maroon p-4 text-center shadow-heritage", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-sans text-sm font-semibold text-cream-light", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-serif font-bold text-gold", children: [
...
function PageTimelinePreLaunch() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { "data-ocid": "timeline-prelaunch.page", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(PageHeading, { title: "Project Time Line – Pre-Launch" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mb-8 font-sans text-sm leading-relaxed text-brown", children: "Before launching the IkatDirect platform, several essential activities must be completed to ensure smooth implementation and long-term sustainability. This is the pre-launch phase where the foundation of the project is developed." }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative mb-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute left-0 right-0 top-10 h-1 rounded-full bg-gradient-to-r from-maroon via-gold to-maroon" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-6 sm:grid-cols-5", children: steps.map((step) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 flex h-20 w-20 flex-col items-center justify-center rounded-full border-4 border-gold bg-maroon shadow-heritage", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-2xl", children: step.icon }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-sans text-xs font-bold text-gold", children: step.n })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-3 rounded-xl border border-gold/40 bg-cream-dark p-3 text-center shadow-xs", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-serif text-xs font-bold text-maroon", children: step.title }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "mt-1 space-y-0.5", children: step.points.map((pt) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { className: "font-sans text-xs text-brown/70", children: pt }, pt)) })
        ] })
      ] }, step.n)) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-xl border-2 border-gold bg-maroon p-5 text-center shadow-heritage", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-sans text-sm font-semibold text-cream-light", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-serif font-bold text-gold", children: "Goal: " }),
      "To prepare the platform for a smooth and successful launch."
    ] }) })
  ] });
}
const weaverFlow = ["Weaver", "Upload", "Display", "Interact", "Sale"];
function PageWeaverPortal() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { "data-ocid": "weaver.page", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(PageHeading, { title: "Weaver Portal" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 gap-8 lg:grid-cols-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "overflow-hidden rounded-2xl border-2 border-gold/60 shadow-heritage", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-maroon px-4 py-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-serif text-sm font-bold text-gold", children: "Weaver Dashboard" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-sans text-xs text-cream-light/70", children: "Welcome, Ramaiah G." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-cream-light p-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-4 grid grid-cols-3 gap-2", children: [
              { v: "12", l: "Products" },
              { v: "₹48K", l: "Earnings" },
              { v: "34", l: "Orders" }
              ...
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-sans text-sm font-bold text-maroon", children: s.v }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-sans text-xs text-brown/60", children: s.l })
                ]
              },
              s.l
            )) }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-lg border border-gold/40 p-3", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mb-2 font-sans text-xs font-bold text-maroon", children: "Upload New Product" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex h-7 items-center rounded border border-gold/30 bg-cream-dark px-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-sans text-xs text-brown/40", children: "Saree name..." }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex h-7 flex-1 items-center rounded border border-gold/30 bg-cream-dark px-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-sans text-xs text-brown/40", children: "Price ₹" }) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "button",
                    {
                      type: "button",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl border border-gold/30 bg-maroon/5 p-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mb-2 text-center font-sans text-xs font-bold text-maroon", children: "Weaver Flow" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap items-center justify-center gap-1", children: weaverFlow.flatMap((s, i) => [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "span",
              {
                className: "rounded-lg bg-maroon px-2 py-1 font-sans text-xs text-cream-light",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 font-sans text-sm leading-relaxed text-brown [text-align:justify]", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "The Weaver Portal is a crucial component of the IkatDirect platform, designed to empower traditional artisans by providing them with direct access to the market without intermediaries." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Upon logging into the platform as a weaver, users are directed to a personalized dashboard where they can upload and manage their products with full control over pricing and product information." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "One of the key advantages of the weaver portal is the ability to engage with customers in real time through integrated messaging and live streaming features." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "The portal also provides tools for managing orders and tracking customer preferences, enabling weavers to improve their services and expand their reach." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Overall, the Weaver Portal transforms the role of artisans from dependent sellers to independent entrepreneurs in a competitive digital marketplace." })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-8 grid grid-cols-2 gap-4 sm:grid-cols-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
...
function PageWebsitePrototype() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { "data-ocid": "prototype.page", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(PageHeading, { title: "Website Prototype" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 gap-8 lg:grid-cols-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 font-sans text-sm leading-relaxed text-brown [text-align:justify]", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "The IkatDirect platform is designed as a user-friendly and interactive web-based application that connects customers and weavers through a structured digital interface. The website serves as the core component of the startup, enabling seamless communication, product browsing, and transactions." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "The platform begins with a login interface, where users are required to select their role as either a Customer or a Weaver. Based on this selection, the system redirects users to their respective dashboards." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "The website is designed using modern web technologies with a focus on simplicity, accessibility, and visual appeal. The interface incorporates a clean layout, intuitive navigation, and categorized product sections to enhance usability." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full max-w-sm overflow-hidden rounded-2xl border-2 border-gold/60 shadow-heritage", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 bg-maroon-dark px-4 py-2", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "h-2.5 w-2.5 rounded-full bg-green-400" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ml-2 flex-1 rounded bg-maroon/40 px-2 py-0.5 font-sans text-xs text-cream-light/60", children: "ikatdirect.com/login" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-cream-light p-6 text-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-serif text-xl font-bold text-maroon", children: "IKAT" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-serif text-xl font-bold text-gold", children: "DIRECT" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1 font-sans text-xs text-brown/60", children: "Connecting Weavers to the World" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "my-4 h-px bg-gold/40" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mb-4 font-sans text-sm font-semibold text-maroon", children: "Select Your Role" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
...
const PAGES = [
  /* @__PURE__ */ jsxRuntimeExports.jsx(PageAbstract, {}, "abstract"),
  /* @__PURE__ */ jsxRuntimeExports.jsx(PageIntroduction, {}, "intro"),
  /* @__PURE__ */ jsxRuntimeExports.jsx(PageSynopsis, {}, "synopsis"),
  /* @__PURE__ */ jsxRuntimeExports.jsx(PageWebsitePrototype, {}, "prototype"),
  /* @__PURE__ */ jsxRuntimeExports.jsx(PageCustomerPortal, {}, "customer"),
  /* @__PURE__ */ jsxRuntimeExports.jsx(PageWeaverPortal, {}, "weaver"),
  /* @__PURE__ */ jsxRuntimeExports.jsx(PagePlatformFeatures, {}, "features"),
  /* @__PURE__ */ jsxRuntimeExports.jsx(PageTimelinePreLaunch, {}, "tl-pre"),
  /* @__PURE__ */ jsxRuntimeExports.jsx(PageTimeline1Year, {}, "tl-1y"),
  /* @__PURE__ */ jsxRuntimeExports.jsx(PageCriticalPath, {}, "cpm"),
  /* @__PURE__ */ jsxRuntimeExports.jsx(PageResources, {}, "resources"),
  /* @__PURE__ */ jsxRuntimeExports.jsx(PageFinance, {}, "finance"),
  /* @__PURE__ */ jsxRuntimeExports.jsx(PageFailures, {}, "failures"),
  /* @__PURE__ */ jsxRuntimeExports.jsx(PageRiskManagement, {}, "risk"),
  /* @__PURE__ */ jsxRuntimeExports.jsx(PageFutureScope, {}, "future"),
  /* @__PURE__ */ jsxRuntimeExports.jsx(PageConclusion, {}, "conclusion")
];
function App() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-cream", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "mx-auto max-w-5xl px-4 pb-16 pt-20", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-6 flex items-center justify-between rounded-xl border border-gold/30 bg-maroon/5 px-5 py-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "flex h-7 w-7 items-center justify-center rounded-full bg-maroon font-sans text-xs font-bold text-gold", children: currentPage }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-serif text-sm font-semibold text-maroon", children: PAGE_TITLES[currentPage - 1] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-sans text-xs text-brown/50", children: "IkatDirect — Digital Project Report" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-2xl bg-cream-light p-8 shadow-heritage", children: PAGES[currentPage - 1] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-8 flex items-center justify-between", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hidden items-center gap-1 sm:flex", children: PAGE_TITLES.map((title, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            type: "button",
            "data-ocid": `page.item.${i + 1}`,
            onClick: () => goTo(i + 1),
            className: `h-2 rounded-full transition-all ${i + 1 === currentPage ? "w-6 bg-maroon" : "w-2 bg-gold/40 hover:bg-gold"}`
          },
          title
        )) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "mt-12 border-t border-gold/30 pt-6 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-sans text-xs text-brown/50", children: [
        "© ",
